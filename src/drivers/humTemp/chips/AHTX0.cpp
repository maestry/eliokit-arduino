 ...
 */
bool AHTX0::begin(TwoWire *wire, int32_t sensor_id,
                           uint8_t i2c_address) {
  ...
  delete humidity_sensor;
  delete temp_sensor;
  humidity_sensor = new AHTX0_Humidity(this);
  temp_sensor = new AHTX0_Temp(this);
  return true;
}
...
*/
/**************************************************************************/
bool AHTX0::getEvent(sensors_event_t *humidity,
...
void AHTX0::fillTempEvent(sensors_event_t *temp, uint32_t timestamp) {
...
void AHTX0::fillHumidityEvent(sensors_event_t *humidity,
                                       uint32_t timestamp) {
 ...
 */
Adafruit_Sensor *AHTX0::getHumiditySensor(void) {
 ...
 * @return Adafruit_Sensor*
 */
Adafruit_Sensor *AHTX0::getTemperatureSensor(void) {
  return temp_sensor;
}
/**
 ...
 */
void AHTX0_Humidity::getSensor(sensor_t *sensor) {
...
/**
    ...
    @returns True
 */
bool AHTX0_Humidity::getEvent(sensors_event_t *event) {
 ...
 * @param sensor The sensor_t object to be populated
 */
void AHTX0_Temp::getSensor(sensor_t *sensor) {
  /* Clear the sensor_t object */
  memset(sensor, 0, sizeof(sensor_t));
...
/*!
    ...
    @returns true
*/
bool AHTX0_Temp::getEvent(sensors_event_t *event) {
