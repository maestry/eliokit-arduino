...
void microphone_record(char* song_name, uint32_t duration) {
  ...
  //Stereo 2 channals
  if (!create_wav_file(song_name, duration, 2, I2S_SAMPLE_RATE, I2S_BITS_PER_SAMPLE)) {
  ...
  uint32_t data_size = 2* I2S_SAMPLE_RATE * I2S_BITS_PER_SAMPLE * duration / 8;
...
void setup() {
  ...
  microphone_record("stereo.wav", 15);
}
